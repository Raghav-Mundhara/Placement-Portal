  ...
  return (
    <div className="min-h-screen w-full bg-slate-100 overflow-hidden">
      ...
      <div className="p-4">
        <h1 className="text-2xl text-black">Registered Students</h1>
        <div className="overflow-x-auto mt-4">
          <div className="min-w-full bg-white border-collapse border border-gray-300">
            <table className="w-full table-auto max-w-full">
              ...
              <tbody>
                {students.map((student) => (
                  <tr key={student.id} className="border border-gray-300">
                    <td className="px-4 py-2 text-slate-400 border border-gray-300" style={{ color: "#94a3b8" }}>
                      {student.name}
                    </td>
                    <td className="px-4 py-2 border border-gray-300">
                      <Link to={`/student-verification`} className="p-2 bg-blue-500 text-white rounded">
                        Verify Student
                      </Link>
                    </td>
                  </tr>
